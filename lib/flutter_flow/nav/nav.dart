...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Forms',
          path: '/forms',
          builder: (context, params) => FormsWidget(
        ...
        FFRoute(
          name: 'Planning',
          path: '/planning',
          builder: (context, params) => PlanningWidget(),
        ),
        FFRoute(
          name: 'Authentication',
          path: '/authentication',
        ...
        FFRoute(
          name: 'adminEvents',
          path: '/adminEvents',
          builder: (context, params) => AdminEventsWidget(),
        ),
        FFRoute(
          name: 'adminEventForm',
          path: '/adminEventForm',
          builder: (context, params) => AdminEventFormWidget(),
        ),
        FFRoute(
          name: 'reviewpage',
          path: '/reviewpage',
        ...
        FFRoute(
          ...
          path: '/adminEventEdit',
          asyncParams: {
            'event': getDoc(['planning'], PlanningRecord.fromSnapshot),
          },
          builder: (context, params) => AdminEventEditWidget(
            event: params.getParam(
              'event',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'reviewadmin',
          path: '/reviewadmin',
          builder: (context, params) => ReviewadminWidget(),
        )
