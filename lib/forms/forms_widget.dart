...
class _FormsWidgetState extends State<FormsWidget> {
  ...
  void initState() {
    ...
    _model.clientNameFocusNode!.addListener(() => safeSetState(() {}));
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.clientNameFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.eventDateFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                  ...
                                  FlutterFlowRadioButton(
                                    ...
                                    onChanged: (val) async {
                                      safeSetState(() {});
                                      FFAppState().venueType = Venuetype.indoor;
                                      safeSetState(() {});
                                    },
                                    controller:
                                  ...
                                  FlutterFlowChoiceChips(
                                    ...
                                    controller:
                                        _model.cateringTypeValueController ??=
                                  ...
                                  FlutterFlowChoiceChips(
                                    ...
                                    alignment: WrapAlignment.start,
                                    controller:
                                        _model.servingTypeValueController ??=
                                            FormFieldController<List<String>>(
                                      [],
                                    ),
                                    wrapped: true,
                      ...
                      onPressed: () async {
                        await EventsRecord.collection
                            ...
                            .set(createEventsRecordData(
                              eventType: widget.event,
                              clientName: _model.clientNameTextController.text,
                              mobileNumber:
                                  _model.mobileNumberTextController.text,
                              email: currentUserEmail,
                              location: _model.eventLocationTextController.text,
                              seats:
                                  int.tryParse(_model.seatsTextController.text),
                              venueType: Venuetype.outdoor,
                              cateringType: CateringType.veg,
                              servingType: ServingType.serving,
                              isCompleted: false,
                              date: _model.eventDateTextController.text,
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text('Event booked for you'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
